                        ...
                        if startreading:
                                ...
                                if j==lyrsthism:
                                        ...
                                        if isray:
                                                ...
                                                self.uzmat[len(y1):len(self.uzmat[:,k]),k]=y1[len(y1)-1]
                                                self.urmat[len(y2):len(self.urmat[:,k]),k]=y2[len(y2)-1]
                                                self.tzmat[len(y3):len(self.tzmat[:,k]),k]=y3[len(y3)-1]
                                                self.trmat[len(y4):len(self.trmat[:,k]),k]=y4[len(y4)-1]
