...
c     +   '/home/keith/codes/surface_waves/earth/common_files/sizes.inc'
      ...
      common/m/d(lyrs),ro(lyrs),vp2(lyrs),vs2(lyrs),
     +          fu(lyrs),n,noc,ist
      dimension y(5),x(5)
      equivalence (y,y1)
...
c**** propagate up layers ****
  100 i=i-1
   ...
   12 del=0.5d0*del
      ...
      write(*,998) i, isplit
  998 format(' count problem in layer ',i5,' isplit is ',i5)
      stop
   10 tes=t1*(y(5)-x(5))
...
c     +   '/home/keith/codes/surface_waves/earth/common_files/sizes.inc'
c      include 
c     +   '/home/keith/codes/surface_waves/earth/common_files/units.inc'
      include './sizes.inc'
      include './units.inc'
...
c     +   '/home/keith/codes/surface_waves/earth/common_files/sizes.inc'
      include './sizes.inc'
      common/bits/u,nsrce,idep(lsd),nord,tpi,sdep(lsd)
...
c     +   '/home/keith/codes/surface_waves/earth/common_files/sizes.inc'
      include './sizes.inc'
      common/x/x(4,lyrs),xx(4),dummy(3*lyrs-4)
      common/m/d(lyrs),ro(lyrs),vp2(lyrs),vs2(lyrs),fu(lyrs),n,noc,ist
      common/fix/b(2,4)
      psq=p*p
      lvz=ist+1
...
c     +   '/home/keith/codes/surface_waves/earth/common_files/sizes.inc'
      include './sizes.inc'
      common/x/x(4,lyrs),dummy(3*lyrs)
      common/fix/b(2,4)
      xx=0.d0
      b22=0.d0
      do 5 k=1,4
...
c     +   '/home/keith/codes/surface_waves/earth/common_files/sizes.inc'
      include './sizes.inc'
      common/x/x(2,lyrs),dummy(5*lyrs)
      common/m/d(lyrs),ro(lyrs),vp2(lyrs),vs2(lyrs),fu(lyrs),n,noc,ist
      psq=p*p
      lvz=ist+1
      do 30 i=noc,ist
